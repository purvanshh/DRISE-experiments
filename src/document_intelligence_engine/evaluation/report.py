...
def _summarize_system(records: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "constraint_flag_rate": _mean_and_std(metric_rows, "constraint_flag_rate"),
        "constraint_repair_rate": _mean_and_std(metric_rows, "constraint_repair_rate"),
    ...
    with path.open("w", encoding="utf-8", newline="") as file_pointer:
        ...
        writer.writerow(
            [
                ...
                "constraint_flag_rate_mean",
                "constraint_repair_rate_mean",
                "latency_ms_mean",
                "cost_usd_mean",
                "cost_usd_total",
                "latency_ms_total",
        ...
        for system_name, metrics in summary.items():
            writer.writerow(
                [
                    ...
                    metrics["constraint_flag_rate"]["mean"],
                    metrics["constraint_repair_rate"]["mean"],
